...
public class CommMonitorInitializer extends ChannelInitializer<SocketChannel> {
	boolean compress = false;
	CommMonitorHandler handler;

	public CommMonitorInitializer(CommMonitorHandler handler, boolean enableCompression) {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("protobufDecoder", new ProtobufDecoder(Image.Request.getDefaultInstance()));
